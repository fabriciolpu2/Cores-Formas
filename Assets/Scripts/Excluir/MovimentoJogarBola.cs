...
public class MovimentoJogarBola: MonoBehaviour
{
	...
	void GetAngle ()
	{
		worldAngle = this.GetComponent<Camera>().ScreenToWorldPoint(new Vector3 (touchEnd.x, touchEnd.y + 800f, ((this.GetComponent<Camera>().nearClipPlane - 50.0f) *1.8f)));
	}
	//no
	//  void PlayWhoosh()
	//  {
